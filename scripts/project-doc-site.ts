...
const REPOSITORY_URL = 'https://github.com/dheiver2/mangaba-harness'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/dheiver2/mangaba-harness/${repositoryRef}/${path}${suffix}`
