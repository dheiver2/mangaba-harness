...
export const pt = {
  ...
  'search.pending': 'Buscando no histórico…',
  'search.noMatches': 'Nenhuma sessão encontrada',
  'menu.addWorkspace': 'Adicionar pasta…',
  'picker.loading': 'Carregando pastas…',
  'folderError.title': 'Não foi possível abrir a pasta',
  'folderError.retry': 'Escolher de novo',
  'rename': 'Renomear',
  'rename.workspace.title': 'Renomear pasta',
  'rename.session.title': 'Renomear sessão',
  'field.workspaceName': 'Nome da pasta',
  'field.sessionName': 'Nome da sessão',
  'delete.workspace': 'Remover pasta',
  'delete.pending': 'Removendo pasta…',
