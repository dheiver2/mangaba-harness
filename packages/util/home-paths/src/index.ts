/**
 * Shared filesystem path helpers for Mangaba Harness user data.
 *
...
/** Directory name for the default Mangaba Harness home under the OS home. */
export const DSH_HOME_DIR_NAME = '.dsh'

/** Stable user-facing display form for the default Mangaba Harness home. */
export const DEFAULT_DSH_HOME_DISPLAY = `~/${DSH_HOME_DIR_NAME}`

/** Environment variable that overrides the default Mangaba Harness home. */
...
/**
 * Resolve the default Mangaba Harness home using Node's platform path rules.
...
/**
 * Resolve the single-root Mangaba Harness home.
 *
...
/**
 * Join path segments onto the resolved Mangaba Harness home.
